...
// import avatar3 from '@/assets/images/users/user.png'
// import avatar4 from '@/assets/images/users/user.png'
// import avatar5 from '@/assets/images/users/user.png'
...
const Topbar = ({ toggleMenu, navOpen }: TopbarProps) => {
	...
	// 	}
	// }
	const { settings, updateSettings } = useThemeContext() //updateSidebar
