...
const ADMIN_ITEMS: MenuItemTypes[] = [
	...
	{
		key: 'statements-dashboard',
		label: 'Statements',
		isTitle: false,
		url: '/query-statements',
	...
	// 			url: '/ui/tables/rolePermission-tables',
	// 			parentKey: 'user-accounts',
	// 		},
	// 		{
	// 			key: 'userAccounts-data',
	// 			label: 'Users Data',
	// 			url: '/ui/tables/userData-tables',
	// 			parentKey: 'user-accounts',
	// 		},
	// 	],
	// },
	...
	// 			key: 'email',
	// 			label: 'Email',
	// 			url: '/ui/forms/email-elements',
	// 			parentKey: 'profile-settings',
	// 		},
	// 		{
	// 			key: 'company',
	// 			label: 'Bank',
	// 			url: '/bank_template_upload',
	// 			parentKey: 'profile-settings',
	// 		},
	// 		{
	// 			key: 'profile',
	...
	// 		},
	// 		{
	// 			key: 'incoming_archive',
	// 			label: 'Incoming Archive',
	// 			url: '/incoming_archive',
	// 			parentKey: 'reports',
	// 		},
	// 		{
	// 			key: 'processed_pass_fail',
	// 			label: 'Processed (Pass/Fail)',
	// 			url: '/processed_pass_fail',
	// 			parentKey: 'reports',
	// 		},
	// 		{
	// 			key: 'processed_logs',
	...
	// 		},
	// 		{
	// 			key: 'outgoing_pass_fail',
	// 			label: 'Outgoing (Pass/Fail)',
	// 			url: '/outgoing_pass_fail',
	// 			parentKey: 'reports',
	// 		},
	// 		{
	// 			key: 'outgoing_logs',
...
export { MENU_ITEMS, HORIZONTAL_MENU_ITEMS, ADMIN_ITEMS }
